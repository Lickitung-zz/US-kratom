 ...
 grunt.initConfig({
   ...
   autoprefixer: {
     ...
     minified: {
       ...
       files: {
        '<%= paths.dist_css %>/styles.min.css': '<%= paths.dist_css %>/styles.min.css'
       }
     },
     bootstrap: {
       options: {
       ...
       files: {
        '<%= paths.src_css_vendor %>/bootstrap.min.css': '<%= paths.src_css_vendor %>/bootstrap.min.css'
       }
     }
   },
   ...
   uglify: {
     main_js: {
       files: {
         '<%= paths.dist_js %>/scripts.min.js': '<%= paths.src_js %>/scripts.js'
       }
     }
   },
