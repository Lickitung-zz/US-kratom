...
export declare function shutdownDb(db: firestore.FirebaseFirestore): Promise<void>;
export declare function waitForPendingWrites(db: firestore.FirebaseFirestore): Promise<void>;
