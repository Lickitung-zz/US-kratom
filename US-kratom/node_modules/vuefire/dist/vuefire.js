...
(function (global, factory) {
  ...
  (global = global || self, factory(global.Vuefire = {}));
  ...
  var DEFAULT_OPTIONS = { reset: true };
  ...
  var DEFAULT_OPTIONS$1 = { maxRefDepth: 2, reset: true };
  ...
  function bindCollection (
    ...
    var resolve = ref.resolve;
    var reject = ref.reject;
    if ( options === void 0 ) options = DEFAULT_OPTIONS$1;

    options = Object.assign({}, DEFAULT_OPTIONS$1, options); // fill default values
  ...
  function rtdbPlugin (
    ...
    if ( ref === void 0 ) ref = {};
    var bindName = ref.bindName; if ( bindName === void 0 ) bindName = '$rtdbBind';
    var unbindName = ref.unbindName; if ( unbindName === void 0 ) unbindName = '$rtdbUnbind';
  ...
  function firestorePlugin (
    ...
    if ( ref === void 0 ) ref = {};
    var bindName = ref.bindName; if ( bindName === void 0 ) bindName = '$bind';
    var unbindName = ref.unbindName; if ( unbindName === void 0 ) unbindName = '$unbind';
